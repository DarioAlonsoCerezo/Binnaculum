...
module MpwBrokerSnapshots =
    ...
    let getBrokerAccountSnapshots
        ...
        [
          ...
          { Data =
              { Id = 0
                Date = DateOnly(2024, 5, 3)
                Broker = Some broker
                BrokerAccount = Some brokerAccount
                Currency = currency
                MovementCounter = 6
                RealizedGains = 5.46m
                RealizedPercentage = 44.7908m
                UnrealizedGains = 0.00m
                UnrealizedGainsPercentage = 0.0000m
                Invested = 0.00m
                Commissions = 4.00m
          ...
          { Data =
              { Id = 0
                Date = DateOnly(2024, 5, 6)
                Broker = Some broker
                BrokerAccount = Some brokerAccount
                Currency = currency
                MovementCounter = 12
                RealizedGains = 5.46m
                RealizedPercentage = 9.6791m
                UnrealizedGains = 0.00m
                UnrealizedGainsPercentage = 0.0000m
                Invested = 0.00m
                Commissions = 10.00m
          ...
          { Data =
              { Id = 0
                Date = DateOnly(2024, 5, 9)
                Broker = Some broker
                BrokerAccount = Some brokerAccount
                Currency = currency
                MovementCounter = 23
                RealizedGains = -9.65m
                RealizedPercentage = -88.2084m
                UnrealizedGains = 0.00m
                UnrealizedGainsPercentage = 0.0000m
                Invested = 0.00m
                Commissions = 13.00m
          ...
          { Data =
              { Id = 0
                Date = DateOnly(2024, 5, 10)
                Broker = Some broker
                BrokerAccount = Some brokerAccount
                Currency = currency
                MovementCounter = 26
                RealizedGains = -9.65m
                RealizedPercentage = -5.0086m
                UnrealizedGains = 0.00m
                UnrealizedGainsPercentage = 0.0000m
                Invested = 0.00m
                Commissions = 15.00m
          ...
          { Data =
              { Id = 0
                Date = DateOnly(2024, 5, 13)
                Broker = Some broker
                BrokerAccount = Some brokerAccount
                Currency = currency
                MovementCounter = 31
                RealizedGains = 46.03m
                RealizedPercentage = 100.0000m
                UnrealizedGains = 0.00m
                UnrealizedGainsPercentage = 0.0000m
                Invested = 0.00m
          ...
          { Data =
              { Id = 0
                Date = DateOnly(2024, 5, 15)
                Broker = Some broker
                BrokerAccount = Some brokerAccount
                Currency = currency
                MovementCounter = 39
                RealizedGains = 46.03m
                RealizedPercentage = 44.2852m
                UnrealizedGains = 0.00m
                UnrealizedGainsPercentage = 0.0000m
                Invested = 0.00m
                Commissions = 23.00m
          ...
          { Data =
              { Id = 0
                Date = DateOnly(2024, 5, 16)
                Broker = Some broker
                BrokerAccount = Some brokerAccount
                Currency = currency
                MovementCounter = 41
                RealizedGains = 46.03m
                RealizedPercentage = 27.1307m
                UnrealizedGains = 0.00m
                UnrealizedGainsPercentage = 0.0000m
                Invested = 0.00m
                Commissions = 25.00m
          ...
          { Data =
              { Id = 0
                Date = DateOnly(2024, 5, 20)
                Broker = Some broker
                BrokerAccount = Some brokerAccount
                Currency = currency
                MovementCounter = 57
                RealizedGains = 85.93m
                RealizedPercentage = 47.0669m
                UnrealizedGains = 0.00m
                UnrealizedGainsPercentage = 0.0000m
                Invested = 0.00m
                Commissions = 33.00m
          ...
          { Data =
              { Id = 0
                Date = DateOnly(2024, 5, 23)
                Broker = Some broker
                BrokerAccount = Some brokerAccount
                Currency = currency
                MovementCounter = 77
                RealizedGains = 165.31m
                RealizedPercentage = 58.6206m
                UnrealizedGains = 0.00m
                UnrealizedGainsPercentage = 0.0000m
                Invested = 0.00m
                Commissions = 43.00m
          ...
          { Data =
              { Id = 0
                Date = DateOnly(2024, 5, 31)
                Broker = Some broker
                BrokerAccount = Some brokerAccount
                Currency = currency
                MovementCounter = 97
                RealizedGains = 140.73m
                RealizedPercentage = 32.0263m
                UnrealizedGains = 0.00m
                UnrealizedGainsPercentage = 0.0000m
                Invested = 0.00m
                Commissions = 53.00m
          ...
          { Data =
              { Id = 0
                Date = DateOnly(2024, 6, 3)
                Broker = Some broker
                BrokerAccount = Some brokerAccount
                Currency = currency
                MovementCounter = 117
                RealizedGains = -141.85m
                RealizedPercentage = -22.6301m
                UnrealizedGains = 0.00m
                UnrealizedGainsPercentage = 0.0000m
                Invested = 0.00m
                Commissions = 63.00m
          ...
          { Data =
              { Id = 0
                Date = DateOnly(2024, 6, 14)
                Broker = Some broker
                BrokerAccount = Some brokerAccount
                Currency = currency
                MovementCounter = 157
                RealizedGains = -141.85m
                RealizedPercentage = -16.4626m
                UnrealizedGains = 0.00m
                UnrealizedGainsPercentage = 0.0000m
                Invested = 0.00m
                Commissions = 83.00m
          ...
          { Data =
              { Id = 0
                Date = DateOnly(2024, 7, 1)
                Broker = Some broker
                BrokerAccount = Some brokerAccount
                Currency = currency
                MovementCounter = 177
                RealizedGains = 345.55m
                RealizedPercentage = 32.0232m
                UnrealizedGains = 0.00m
                UnrealizedGainsPercentage = 0.0000m
                Invested = 0.00m
                Commissions = 93.00m
                ...
                Withdrawn = 0.00m
                DividendsReceived = 0.00m
                OptionsIncome = 1195.00m
                OtherIncome = 0.00m
                OpenTrades = true
                NetCashFlow = 1079.06m }
            Description = "BrokerSnapshot 14: 2024-07-01" }
          // BrokerSnapshot 15: 2024-07-02
          { Data =
              { Id = 0
                Date = DateOnly(2024, 7, 2)
                Broker = Some broker
                BrokerAccount = Some brokerAccount
                Currency = currency
                MovementCounter = 197
                RealizedGains = 352.96m
                RealizedPercentage = 28.3168m
                UnrealizedGains = 0.00m
                UnrealizedGainsPercentage = 0.0000m
                Invested = 0.00m
                Commissions = 103.00m
                ...
                Withdrawn = 0.00m
                DividendsReceived = 0.00m
                OptionsIncome = 1375.00m
                OtherIncome = 0.00m
                OpenTrades = true
                NetCashFlow = 1246.47m }
            Description = "BrokerSnapshot 15: 2024-07-02" }
          // BrokerSnapshot 16: 2024-07-09
          { Data =
              { Id = 0
                Date = DateOnly(2024, 7, 9)
                Broker = Some broker
                BrokerAccount = Some brokerAccount
                Currency = currency
                MovementCounter = 199
                RealizedGains = 352.96m
                RealizedPercentage = 25.6891m
                UnrealizedGains = 0.00m
                UnrealizedGainsPercentage = 0.0000m
                Invested = 0.00m
                Commissions = 103.00m
                ...
                Deposited = 0.00m
                Withdrawn = 0.00m
                DividendsReceived = 127.50m
                OptionsIncome = 1375.00m
                OtherIncome = 0.00m
                OpenTrades = true
                NetCashFlow = 1373.97m }
            Description = "BrokerSnapshot 16: 2024-07-09" }
          // BrokerSnapshot 17: 2024-07-16
          { Data =
              { Id = 0
                Date = DateOnly(2024, 7, 16)
                Broker = Some broker
                BrokerAccount = Some brokerAccount
                Currency = currency
                MovementCounter = 222
                RealizedGains = -119.63m
                RealizedPercentage = -11.0875m
                UnrealizedGains = 0.00m
                UnrealizedGainsPercentage = 0.0000m
                Invested = 0.00m
                Commissions = 116.00m
                ...
                Withdrawn = 0.00m
                DividendsReceived = 127.50m
                OptionsIncome = 1096.00m
                OtherIncome = 0.00m
                OpenTrades = true
                NetCashFlow = 1078.96m }
            Description = "BrokerSnapshot 17: 2024-07-16" }
          // BrokerSnapshot 18: 2024-07-24
          { Data =
              { Id = 0
                Date = DateOnly(2024, 7, 24)
                Broker = Some broker
                BrokerAccount = Some brokerAccount
                Currency = currency
                MovementCounter = 244
                RealizedGains = -386.76m
                RealizedPercentage = -54.1605m
                UnrealizedGains = 0.00m
                UnrealizedGainsPercentage = 0.0000m
                Invested = 0.00m
                Commissions = 126.00m
          ...
          { Data =
              { Id = 0
                Date = DateOnly(2024, 7, 31)
                Broker = Some broker
                BrokerAccount = Some brokerAccount
                Currency = currency
                MovementCounter = 247
                RealizedGains = -386.76m
                RealizedPercentage = -51.5206m
                UnrealizedGains = 0.00m
                UnrealizedGainsPercentage = 0.0000m
                Invested = 0.00m
                Commissions = 129.00m
          ...
          { Data =
              { Id = 0
                Date = DateOnly(2024, 8, 1)
                Broker = Some broker
                BrokerAccount = Some brokerAccount
                Currency = currency
                MovementCounter = 249
                RealizedGains = -387.03m
                RealizedPercentage = -50.2356m
                UnrealizedGains = 0.00m
                UnrealizedGainsPercentage = 0.0000m
                Invested = 0.00m
                Commissions = 130.00m
          ...
          { Data =
              { Id = 0
                Date = DateOnly(2024, 8, 2)
                Broker = Some broker
                BrokerAccount = Some brokerAccount
                Currency = currency
                MovementCounter = 251
                RealizedGains = -387.29m
                RealizedPercentage = -48.8910m
                UnrealizedGains = 0.00m
                UnrealizedGainsPercentage = 0.0000m
                Invested = 0.00m
                Commissions = 131.00m
          ...
          { Data =
              { Id = 0
                Date = DateOnly(2024, 8, 6)
                Broker = Some broker
                BrokerAccount = Some brokerAccount
                Currency = currency
                MovementCounter = 254
                RealizedGains = -351.09m
                RealizedPercentage = -46.8264m
                UnrealizedGains = 0.00m
                UnrealizedGainsPercentage = 0.0000m
                Invested = 0.00m
                Commissions = 131.00m
          ...
          { Data =
              { Id = 0
                Date = DateOnly(2024, 8, 15)
                Broker = Some broker
                BrokerAccount = Some brokerAccount
                Currency = currency
                MovementCounter = 309
                RealizedGains = -150.16m
                RealizedPercentage = -13.8956m
                UnrealizedGains = 0.00m
                UnrealizedGainsPercentage = 0.0000m
                Invested = 0.00m
                Commissions = 151.00m
                ...
                Withdrawn = 0.00m
                DividendsReceived = 127.50m
                OptionsIncome = 1144.00m
                OtherIncome = 0.00m
                OpenTrades = true
                NetCashFlow = 1080.60m }
            Description = "BrokerSnapshot 23: 2024-08-15" }
          // BrokerSnapshot 24: 2024-08-16
          { Data =
              { Id = 0
                Date = DateOnly(2024, 8, 16)
                Broker = Some broker
                BrokerAccount = Some brokerAccount
                Currency = currency
                MovementCounter = 319
                RealizedGains = -122.74m
                RealizedPercentage = -13.8788m
                UnrealizedGains = 0.00m
                UnrealizedGainsPercentage = 0.0000m
                Invested = 0.00m
                Commissions = 151.00m
          ...
          { Data =
              { Id = 0
                Date = DateOnly(2024, 8, 19)
                Broker = Some broker
                BrokerAccount = Some brokerAccount
                Currency = currency
                MovementCounter = 332
                RealizedGains = -45.32m
                RealizedPercentage = -5.3904m
                UnrealizedGains = 0.00m
                UnrealizedGainsPercentage = 0.0000m
                Invested = 0.00m
                Commissions = 154.00m
          ...
          { Data =
              { Id = 0
                Date = DateOnly(2024, 8, 20)
                Broker = Some broker
                BrokerAccount = Some brokerAccount
                Currency = currency
                MovementCounter = 343
                RealizedGains = -42.08m
                RealizedPercentage = -4.6485m
                UnrealizedGains = 0.00m
                UnrealizedGainsPercentage = 0.0000m
                Invested = 0.00m
                Commissions = 164.00m
          ...
          { Data =
              { Id = 0
                Date = DateOnly(2024, 8, 22)
                Broker = Some broker
                BrokerAccount = Some brokerAccount
                Currency = currency
                MovementCounter = 345
                RealizedGains = -38.61m
                RealizedPercentage = -4.2948m
                UnrealizedGains = 0.00m
                UnrealizedGainsPercentage = 0.0000m
                Invested = 0.00m
                Commissions = 164.00m
          ...
          { Data =
              { Id = 0
                Date = DateOnly(2024, 8, 23)
                Broker = Some broker
                BrokerAccount = Some brokerAccount
                Currency = currency
                MovementCounter = 346
                RealizedGains = -38.61m
                RealizedPercentage = -4.2343m
                UnrealizedGains = 0.00m
                UnrealizedGainsPercentage = 0.0000m
                Invested = 0.00m
                Commissions = 165.00m
          ...
          { Data =
              { Id = 0
                Date = DateOnly(2024, 8, 26)
                Broker = Some broker
                BrokerAccount = Some brokerAccount
                Currency = currency
                MovementCounter = 349
                RealizedGains = -48.39m
                RealizedPercentage = -5.5656m
                UnrealizedGains = 0.00m
                UnrealizedGainsPercentage = 0.0000m
                Invested = 0.00m
                Commissions = 165.00m
          ...
          { Data =
              { Id = 0
                Date = DateOnly(2024, 8, 29)
                Broker = Some broker
                BrokerAccount = Some brokerAccount
                Currency = currency
                MovementCounter = 357
                RealizedGains = 21.52m
                RealizedPercentage = 2.5549m
                UnrealizedGains = 0.00m
                UnrealizedGainsPercentage = 0.0000m
                Invested = 0.00m
                Commissions = 165.00m
          ...
          { Data =
              { Id = 0
                Date = DateOnly(2024, 8, 30)
                Broker = Some broker
                BrokerAccount = Some brokerAccount
                Currency = currency
                MovementCounter = 358
                RealizedGains = 25.25m
                RealizedPercentage = 3.0305m
                UnrealizedGains = 0.00m
                UnrealizedGainsPercentage = 0.0000m
                Invested = 0.00m
                Commissions = 165.00m
          ...
          { Data =
              { Id = 0
                Date = DateOnly(2024, 9, 3)
                Broker = Some broker
                BrokerAccount = Some brokerAccount
                Currency = currency
                MovementCounter = 364
                RealizedGains = 25.25m
                RealizedPercentage = 2.9278m
                UnrealizedGains = 0.00m
                UnrealizedGainsPercentage = 0.0000m
                Invested = 0.00m
                Commissions = 171.00m
          ...
          { Data =
              { Id = 0
                Date = DateOnly(2024, 9, 4)
                Broker = Some broker
                BrokerAccount = Some brokerAccount
                Currency = currency
                MovementCounter = 369
                RealizedGains = 71.46m
                RealizedPercentage = 10.4794m
                UnrealizedGains = 0.00m
                UnrealizedGainsPercentage = 0.0000m
                Invested = 0.00m
                Commissions = 171.00m
          ...
          { Data =
              { Id = 0
                Date = DateOnly(2024, 9, 6)
                Broker = Some broker
                BrokerAccount = Some brokerAccount
                Currency = currency
                MovementCounter = 373
                RealizedGains = 71.46m
                RealizedPercentage = 10.1025m
                UnrealizedGains = 0.00m
                UnrealizedGainsPercentage = 0.0000m
                Invested = 0.00m
                Commissions = 175.00m
          ...
          { Data =
              { Id = 0
                Date = DateOnly(2024, 9, 10)
                Broker = Some broker
                BrokerAccount = Some brokerAccount
                Currency = currency
                MovementCounter = 383
                RealizedGains = 173.85m
                RealizedPercentage = 48.8329m
                UnrealizedGains = 0.00m
                UnrealizedGainsPercentage = 0.0000m
                Invested = 0.00m
                Commissions = 175.00m
          ...
          { Data =
              { Id = 0
                Date = DateOnly(2024, 9, 12)
                Broker = Some broker
                BrokerAccount = Some brokerAccount
                Currency = currency
                MovementCounter = 388
                RealizedGains = 43.31m
                RealizedPercentage = 11.6322m
                UnrealizedGains = 0.00m
                UnrealizedGainsPercentage = 0.0000m
                Invested = 0.00m
                Commissions = 178.00m
          ...
          { Data =
              { Id = 0
                Date = DateOnly(2024, 9, 13)
                Broker = Some broker
                BrokerAccount = Some brokerAccount
                Currency = currency
                MovementCounter = 394
                RealizedGains = 87.91m
                RealizedPercentage = 23.6108m
                UnrealizedGains = 0.00m
                UnrealizedGainsPercentage = 0.0000m
                Invested = 0.00m
                Commissions = 178.00m
          ...
          { Data =
              { Id = 0
                Date = DateOnly(2024, 9, 16)
                Broker = Some broker
                BrokerAccount = Some brokerAccount
                Currency = currency
                MovementCounter = 396
                RealizedGains = 87.91m
                RealizedPercentage = 21.4913m
                UnrealizedGains = 0.00m
                UnrealizedGainsPercentage = 0.0000m
                Invested = 0.00m
                Commissions = 180.00m
          ...
          { Data =
              { Id = 0
                Date = DateOnly(2024, 9, 17)
                Broker = Some broker
                BrokerAccount = Some brokerAccount
                Currency = currency
                MovementCounter = 404
                RealizedGains = -235.17m
                RealizedPercentage = -52.4968m
                UnrealizedGains = 0.00m
                UnrealizedGainsPercentage = 0.0000m
                Invested = 0.00m
                Commissions = 184.00m
          ...
          { Data =
              { Id = 0
                Date = DateOnly(2024, 9, 24)
                Broker = Some broker
                BrokerAccount = Some brokerAccount
                Currency = currency
                MovementCounter = 408
                RealizedGains = -235.17m
                RealizedPercentage = -48.6481m
                UnrealizedGains = 0.00m
                UnrealizedGainsPercentage = 0.0000m
                Invested = 0.00m
                Commissions = 188.00m
          ...
          { Data =
              { Id = 0
                Date = DateOnly(2024, 9, 25)
                Broker = Some broker
                BrokerAccount = Some brokerAccount
                Currency = currency
                MovementCounter = 416
                RealizedGains = -64.25m
                RealizedPercentage = -14.5254m
                UnrealizedGains = 0.00m
                UnrealizedGainsPercentage = 0.0000m
                Invested = 0.00m
                Commissions = 192.00m
          ...
          { Data =
              { Id = 0
                Date = DateOnly(2024, 10, 2)
                Broker = Some broker
                BrokerAccount = Some brokerAccount
                Currency = currency
                MovementCounter = 418
                RealizedGains = -59.79m
                RealizedPercentage = -14.5804m
                UnrealizedGains = 0.00m
                UnrealizedGainsPercentage = 0.0000m
                Invested = 0.00m
                Commissions = 192.00m
          ...
          { Data =
              { Id = 0
                Date = DateOnly(2024, 10, 4)
                Broker = Some broker
                BrokerAccount = Some brokerAccount
                Currency = currency
                MovementCounter = 422
                RealizedGains = -24.35m
                RealizedPercentage = -5.9380m
                UnrealizedGains = 0.00m
                UnrealizedGainsPercentage = 0.0000m
                Invested = 0.00m
                Commissions = 192.00m
          ...
          { Data =
              { Id = 0
                Date = DateOnly(2024, 10, 7)
                Broker = Some broker
                BrokerAccount = Some brokerAccount
                Currency = currency
                MovementCounter = 425
                RealizedGains = 47.84m
                RealizedPercentage = 13.9199m
                UnrealizedGains = 0.00m
                UnrealizedGainsPercentage = 0.0000m
                Invested = 0.00m
                Commissions = 192.00m
          ...
          { Data =
              { Id = 0
                Date = DateOnly(2024, 10, 8)
                Broker = Some broker
                BrokerAccount = Some brokerAccount
                Currency = currency
                MovementCounter = 427
                RealizedGains = 129.30m
                RealizedPercentage = 53.5581m
                UnrealizedGains = 0.00m
                UnrealizedGainsPercentage = 0.0000m
                Invested = 0.00m
                Commissions = 192.00m
          ...
          { Data =
              { Id = 0
                Date = DateOnly(2024, 10, 10)
                Broker = Some broker
                BrokerAccount = Some brokerAccount
                Currency = currency
                MovementCounter = 430
                RealizedGains = 5078.19m
                RealizedPercentage = 1647.1052m
                UnrealizedGains = 0.00m
                UnrealizedGainsPercentage = 0.0000m
                Invested = 0.00m
                Commissions = 192.00m
          ...
          { Data =
              { Id = 0
                Date = DateOnly(2024, 11, 5)
                Broker = Some broker
                BrokerAccount = Some brokerAccount
                Currency = currency
                MovementCounter = 437
                RealizedGains = 5080.92m
                RealizedPercentage = 0.0000m
                UnrealizedGains = 0.00m
                UnrealizedGainsPercentage = 0.0000m
                Invested = 0.00m
          ...
          { Data =
              { Id = 0
                ...
                Currency = currency
                MovementCounter = 442
                RealizedGains = 4854.61m
                RealizedPercentage = 5729.5055m
                UnrealizedGains = 0.00m
                UnrealizedGainsPercentage = 0.0000m
                Invested = 0.00m
                Commissions = 198.00m
          ...
          { Data =
              { Id = 0
                Date = DateOnly(2025, 1, 17)
                Broker = Some broker
                BrokerAccount = Some brokerAccount
                Currency = currency
                MovementCounter = 450
                RealizedGains = 4878.35m
                RealizedPercentage = 0.0000m
                UnrealizedGains = 0.00m
                UnrealizedGainsPercentage = 0.0000m
                Invested = 0.00m
          ...
          { Data =
              { Id = 0
                Date = DateOnly(2025, 1, 21)
                Broker = Some broker
                BrokerAccount = Some brokerAccount
                Currency = currency
                MovementCounter = 456
                RealizedGains = 4873.78m
                RealizedPercentage = 4690.8373m
                UnrealizedGains = 0.00m
                UnrealizedGainsPercentage = 0.0000m
                Invested = 0.00m
                Commissions = 205.00m
          ...
          { Data =
              { Id = 0
                Date = DateOnly(2025, 2, 28)
                Broker = Some broker
                BrokerAccount = Some brokerAccount
                Currency = currency
                MovementCounter = 459
                RealizedGains = 4812.51m
                RealizedPercentage = 0.0000m
                UnrealizedGains = 0.00m
                UnrealizedGainsPercentage = 0.0000m
                Invested = 0.00m
          ...
          { Data =
              { Id = 0
                Date = DateOnly(2025, 3, 27)
                Broker = Some broker
                BrokerAccount = Some brokerAccount
                Currency = currency
                MovementCounter = 462
                RealizedGains = 4914.96m
                RealizedPercentage = 3387.7585m
                UnrealizedGains = 0.00m
                UnrealizedGainsPercentage = 0.0000m
                Invested = 0.00m
                Commissions = 208.00m
          ...
          { Data =
              { Id = 0
                Date = DateOnly(2025, 9, 26)
                Broker = Some broker
                BrokerAccount = Some brokerAccount
                Currency = currency
                MovementCounter = 472
                RealizedGains = 4959.60m
                RealizedPercentage = 0.0000m
                UnrealizedGains = 0.00m
                UnrealizedGainsPercentage = 0.0000m
                Invested = 0.00m
          ...
          { Data =
              { Id = 0
                Date = DateOnly(2025, 10, 17)
                Broker = Some broker
                BrokerAccount = Some brokerAccount
                Currency = currency
                MovementCounter = 478
                RealizedGains = 4986.23m
                RealizedPercentage = 0.0000m
                UnrealizedGains = 0.00m
                UnrealizedGainsPercentage = 0.0000m
                Invested = 0.00m
          ...
          { Data =
              { Id = 0
                ...
                OpenTrades = true
                NetCashFlow = -232.52m }
            Description = "BrokerSnapshot 66: Today" } ]
