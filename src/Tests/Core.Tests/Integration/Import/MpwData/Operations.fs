        ...
        [
          ...
          { Data =
              { Id = 0
                ...
                CloseDate = Some(DateTime(2025, 11, 7, 0, 0, 1))
                Realized = 5072.73m
                RealizedToday = 4948.89m
                Commissions = 190.00m
                Fees = 54.65m
                Premium = 352.00m
                Dividends = 230.00m
                DividendTaxes = 34.50m
                CapitalDeployed = 25900.00m
                CapitalDeployedToday = 0.00m
          ...
          { Data =
              { Id = 0
                ...
                CloseDate = Some(DateTime(2025, 11, 7, 0, 0, 1))
                Realized = -223.58m
                RealizedToday = -226.31m
                Commissions = 6.00m
                Fees = 1.58m
                Premium = -216.00m
                Dividends = 0.00m
                DividendTaxes = 0.00m
                CapitalDeployed = 1950.00m
                CapitalDeployedToday = 0.00m
          ...
          { Data =
              { Id = 0
                ...
                CloseDate = Some(DateTime(2025, 11, 7, 0, 0, 1))
                Realized = 41.18m
                RealizedToday = 102.45m
                Commissions = 3.00m
                Fees = 0.82m
                Premium = 45.00m
                Dividends = 0.00m
                DividendTaxes = 0.00m
                CapitalDeployed = 200.00m
                CapitalDeployedToday = 0.00m
