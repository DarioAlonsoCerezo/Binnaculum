...
module internal TickerSnapshotQuery =
    let createTable =
        ...
        (
            ...
            {CostBasis} TEXT NOT NULL DEFAULT '0',
            {RealCost} TEXT NOT NULL DEFAULT '0', 
            {Dividends} TEXT NOT NULL DEFAULT '0',
            {Options} TEXT NOT NULL DEFAULT '0',
            {TotalIncomes} TEXT NOT NULL DEFAULT '0',
            {Unrealized} TEXT NOT NULL DEFAULT '0',
            {Realized} TEXT NOT NULL DEFAULT '0',
            {Performance} TEXT NOT NULL,
            {LatestPrice} TEXT NOT NULL DEFAULT '0',
