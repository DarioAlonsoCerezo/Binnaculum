        ...
        task {
            try
                CoreLogger.logDebugf
                    "Creator"
                    "SaveBrokerMovement ENTRY - Amount: %A, Type: %A, BrokerAccountId: %A, Date: %A"
                    movement.Amount
                ...
                CoreLogger.logDebugf
                    "Creator"
                    "SaveBrokerMovement - About to update snapshots for movement date: %A, Amount: %A, Type: %A"
                    movementDatePattern
                    movement.Amount
                    movement.MovementType
                ...
                CoreLogger.logDebugf
                    "Creator"
                    "Checking if historical movement - Movement date: %A, Today: %A"
                    movementDate
                    today
                ...
                if movementDate < today then
                    CoreLogger.logDebugf
                        "Creator"
                        "*** HISTORICAL MOVEMENT DETECTED *** - Movement date: %A, Today: %A"
                        movementDate
                        today

                    CoreLogger.logDebugf
                        "Creator"
                        "About to update today's snapshot to reflect historical deposit of %A"
                        movement.Amount
