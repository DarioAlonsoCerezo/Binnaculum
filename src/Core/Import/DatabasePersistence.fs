            ...
            try
                ...
                for brokerMovement in input.BrokerMovements do
                    ...
                    try
                        ...
                        ImportState.updateStatus (SavingToDatabase($"Saving broker movements {processedCount} of {totalItems}", progress))
                    with ex ->
                ...
                for optionTrade in input.OptionTrades do
                    ...
                    try
                        ...
                        processedCount <- processedCount + 1
                        let progress = float processedCount / float totalItems
                        ImportState.updateStatus (SavingToDatabase($"Saving option trades {processedCount} of {totalItems}", progress))
                    with ex ->
                ...
                for stockTrade in input.StockTrades do
                    ...
                    try
                        ...
                        processedCount <- processedCount + 1
                        let progress = float processedCount / float totalItems
                        ImportState.updateStatus (SavingToDatabase($"Saving stock trades {processedCount} of {totalItems}", progress))
                    with ex ->
                ...
                for dividend in input.Dividends do
                    ...
                    try
                        ...
                        processedCount <- processedCount + 1
                        let progress = float processedCount / float totalItems
                        ImportState.updateStatus (SavingToDatabase($"Saving dividends {processedCount} of {totalItems}", progress))
                    with ex ->
                ...
                for dividendTax in input.DividendTaxes do
                    ...
                    try
                        ...
                        processedCount <- processedCount + 1
                        let progress = float processedCount / float totalItems
                        ImportState.updateStatus (SavingToDatabase($"Saving dividend taxes {processedCount} of {totalItems}", progress))
                    with ex ->
