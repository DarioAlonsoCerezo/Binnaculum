...
type Do() =
    ...
    static member fill(tickerPrice: TickerPrice, command: SqliteCommand) =
        command.fillEntityAuditable<TickerPrice> (
            [ (SQLParameterName.PriceDate, tickerPrice.PriceDate.ToString())
    ...
    static member getAll() =
        Database.Do.getAllEntities Do.read TickerPriceQuery.getAll

    static member getById(id: int) =
        Database.Do.getById Do.read id TickerPriceQuery.getById
